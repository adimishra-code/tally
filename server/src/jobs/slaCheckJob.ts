        ...
        if (!existingAlert) {
          ...
          const alert = await Alert.create({
            ...
            metadata: {
              ...
              status: order.status,
              warehouseId: (order.warehouseId as any)._id ? (order.warehouseId as any)._id.toString() : order.warehouseId.toString(),
              warehouseName: (order.warehouseId as any)?.name || 'Warehouse',
